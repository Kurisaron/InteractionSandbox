...
INTERACTIONSANDBOX_API UClass* Z_Construct_UClass_AShooterNPC();
INTERACTIONSANDBOX_API UClass* Z_Construct_UClass_AShooterNPC_NoRegister();
INTERACTIONSANDBOX_API UClass* Z_Construct_UClass_AShooterWeapon_NoRegister();
...
struct Z_Construct_UDelegateFunction_InteractionSandbox_PawnDeathDelegate__DelegateSignature_Statics
{
#if WITH_METADATA
...
const UECodeGen_Private::FDelegateFunctionParams Z_Construct_UDelegateFunction_InteractionSandbox_PawnDeathDelegate__DelegateSignature_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UPackage__Script_InteractionSandbox, nullptr, "PawnDeathDelegate__DelegateSignature", nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_InteractionSandbox_PawnDeathDelegate__DelegateSignature_Statics::Function_MetaDataParams), Z_Construct_UDelegateFunction_InteractionSandbox_PawnDeathDelegate__DelegateSignature_Statics::Function_MetaDataParams)},  };
UFunction* Z_Construct_UDelegateFunction_InteractionSandbox_PawnDeathDelegate__DelegateSignature()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUDelegateFunction(&ReturnFunction, Z_Construct_UDelegateFunction_InteractionSandbox_PawnDeathDelegate__DelegateSignature_Statics::FuncParams);
	}
...
const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_AShooterNPC_Statics::InterfaceParams[] = {
	{ Z_Construct_UClass_UShooterWeaponHolder_NoRegister, (int32)VTABLE_OFFSET(AShooterNPC, IShooterWeaponHolder), false },  // 1666551206
};
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Github_InteractionSandbox_InteractionSandbox_Source_InteractionSandbox_Variant_Shooter_AI_ShooterNPC_h__Script_InteractionSandbox_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AShooterNPC, AShooterNPC::StaticClass, TEXT("AShooterNPC"), &Z_Registration_Info_UClass_AShooterNPC, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AShooterNPC), 1712607822U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Github_InteractionSandbox_InteractionSandbox_Source_InteractionSandbox_Variant_Shooter_AI_ShooterNPC_h__Script_InteractionSandbox_1771383996(TEXT("/Script/InteractionSandbox"),
	Z_CompiledInDeferFile_FID_Github_InteractionSandbox_InteractionSandbox_Source_InteractionSandbox_Variant_Shooter_AI_ShooterNPC_h__Script_InteractionSandbox_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Github_InteractionSandbox_InteractionSandbox_Source_InteractionSandbox_Variant_Shooter_AI_ShooterNPC_h__Script_InteractionSandbox_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
